...
class Draw:
    ...
    _provinces = ["皖", "沪", "津", "渝", "冀", "晋", "蒙", "辽", "吉", "黑", "苏", "浙", "京", "闽", "赣", "鲁", "豫", "鄂", "湘", "粤",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num", help="set the number of plates (default: 9)", type=int, default=3)
    ...
    for i in tqdm(range(args.num)):
        ...
        plate.save(f"{train_path}/{label}.jpg")
